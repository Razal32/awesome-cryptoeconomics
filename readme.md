...
1.  [Cryptoeconomics Definitions Part 1](https://cryptoeconomics.asia/2017/09/04/cryptoeconomics-definitions-p1/), [Part 2](https://cryptoeconomics.asia/2017/09/05/cryptoeconomics-definition/) and [Part 3](https://cryptoeconomics.asia/2017/09/25/cryptoeconomics-definitions-blockchain-economics/) искать
...
1.  [How to create a cryptoeconomic protocol from scratch](https://blog.verity.site/vlad-zamfir-creating-a-cryptoeconomic-protocol-from-scratch-1404b61764bf) by Vlad Zamfir
...
1. [The need for an Incentive scheme in Algorand](https://blockchainatberkeley.blog/the-need-for-an-incentive-scheme-in-algorand-6fe9db45f2a7) by Alexis Guaba, Zubin Koticha Искать
1. [Cryptoeconomics.study](https://cryptoeconomics.study) -- An free and open source book & course on Cryptoeconomics Истек сертификат, осторожно
